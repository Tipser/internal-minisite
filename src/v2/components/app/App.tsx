...
import './App.scss';
import 'tipser-elements-v2/dist/index.css';
...
import { TipserElementsConfig } from 'tipser-elements-v2/dist/config';
...
const RouterHistory = withRouter(({ children, history, match }: any) => {
  return children(history, match.params);
});
